...
###### ---------------------------------------------------------------------- ######
ncomp <- 50
features <- read.csv(file = paste0("../../data/Fluid density/features",ncomp,".csv"), header = FALSE, row.names = NULL)
components <- read.csv(file = paste0("../../data/Fluid density/components",ncomp,".csv"), header = FALSE, row.names = NULL)
...
pal <- RColorBrewer::brewer.pal(10, "YlGnBu")
